...
public class ConsoleScreen
{
    ...
    public void PrintDisplay(string message1, string message2, string message3, string message4, string message5, string message6, string message7, string message8)
    {
        Console.Clear();
        Console.WriteLine(UserInterfaceComponents.TopLine);
        Console.WriteLine(UserInterfaceComponents.AppName);
        for (int i = 0; i < 9; i++)
        {
            ...
            {
                Console.WriteLine(UserInterfaceComponents.GetMessageString(message8));
            }
            else
            {
                Console.WriteLine(UserInterfaceComponents.MiddleLine);
